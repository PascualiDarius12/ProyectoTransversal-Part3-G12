...
//        Alumno al = new Alumno(1, "21588754", "pascuali", "darius", LocalDate.parse("1980-12-12"), true);
//         Alumno a2 = new Alumno(2,"34789754", "ortiz", "pedro", LocalDate.parse("1980-12-12"), true);
//        AlumnoData alD = new AlumnoData();
//        alD.guardarAlumno(al);
//        alD.guardarAlumno(a2);
